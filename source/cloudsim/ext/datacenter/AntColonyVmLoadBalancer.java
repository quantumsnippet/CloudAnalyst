...
public class AntColonyVmLoadBalancer extends VmLoadBalancer 
{
	...
	static final double alpha = 1;			//Exploitation parameter, sets how the ants are attracted to pheromone concentration.
	static final double beta = 1;			//Exploration parameter, sets how the ants are more attracted to try out shorter paths.
	...
	public class Ant 
	{
		...
		{
			return ((VirtualMachine) dcbLocal.vmlist.get(ProcessAnt(false /* updatePheromones */))).getVmId();
		}
